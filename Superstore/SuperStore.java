...
//TURN CATEGORIES INTO SUBCLASSES
...
public class SuperStore {
    ...
    public static void main(String[] args) throws Exception {
        ...
        items.add(new Item("Chauffeur", 30000, 40000));
        items.add(new Item("Housekeeper", 45000, 50000));
        items.add(new Item("Private Chef", 90000, 100000));
        items.add(new Item("Pilot", 90000, 100000));
        items.add(new Item("Lifeguard", 30000, 45000));
        items.add(new Item("Gardener", 35000, 40000));
        items.add(new Item("Victorian Mansion", 600000, 800000));
        items.add(new Item("Modern Flat", 2000000, 3000000));
        items.add(new Item("Mobile Home", 80000, 100000));
        items.add(new Item("Canopy", 25000, 50000));
        items.add(new Item("Pool", 50000, 75000));
        items.add(new Item("Hot Tub", 10000, 15000));
        items.add(new Item("Bowling Alley", 400000, 450000));
        items.add(new Item("Karaoke Machine", 2000, 2500));
        items.add(new Item("Seaplane", 30000, 35000));
        items.add(new Item("Helicopter", 1500000, 1600000));
        items.add(new Item("Gaming Setup", 10000, 12000));
        items.add(new Item("Movie Theater", 10000, 15000));
        items.add(new Item("Beachside Villa", 2000, 3000));
        items.add(new Item("Amusement Park", 10000000, 15000000));
        items.add(new Item("Arcade", 4000, 4500));
        //begins the game
        openingText();
        
        for (;;) { //loops the game until the player wins or chooses to quit
            inputCommand();
    ...
    static void openingText() {
        ...
        System.out.println("");
        System.out.println("There's only so much space on your island, so you may only buy 5 food items, hire 10 employees, and buy 7 leisure facilities, at most.");
